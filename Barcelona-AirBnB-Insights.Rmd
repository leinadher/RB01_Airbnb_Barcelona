...
This chart contrasts two categories of landlords: `Small tenant` and `Large tenant`, based on the number of listings they possess. The category `Small tenant` outnumbers `Large tenant`, indicating a slightly higher prevalence of landlords with fewer properties.
