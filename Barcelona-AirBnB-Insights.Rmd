...
#### 2.3.3. Proportion of Airbnb listings per person by neighbourhood group
...
```{r plot7, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, results='hide', fig.keep='all', fig.width=8, fig.height=3, fig.align='center'}

# PLOT 7: GREAT AND SMALL TENANTS
...
#### 2.3.9. Top hosts by number of listings
...
#### 2.3.10. Average price by neighbourhood map overview
...
#### 2.3.12. Listings by minimum nights
...
#### 2.3.14. Boxplots by minimum nights
...
#### 2.3.15. Boxplots by number of reviews
