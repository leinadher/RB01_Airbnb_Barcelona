...
Explain the use of API connection to retrieve the Ope
Explain the use of library(gridExtra) for dividing the ggplot2 layout
Also, explain how the following libraries were at some point loaded as we were experimenting and producing plots, but were discarded due to complications.
...
Specifically plotly was considered for making interactive maps, but combined with the large-sized map tiles, resulted in laggy and heavy HTML files, and were decided to be discarded for regular PNG images.
