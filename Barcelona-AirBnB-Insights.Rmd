...
Barcelona_md <- filter(Barcelona_md, price < 20000)
...
m <- ggmap(map_BCN) +
  geom_sf(data = merged_data,
          ...
          color = "#f1796f",
          linewidth = 0.3) +
  scale_fill_gradient(low = alpha("white", 0), high = alpha("#f1796f", 0.8)) +
  theme_minimal() +
...
``` {r plot10_plotly, echo=FALSE, fig.align='center', fig.height=10, fig.keep='all', fig.width=10}
...
#### 2.3.13. Price boxplots by neighbourhood group
