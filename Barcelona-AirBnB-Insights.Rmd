...
#### 2.3.2. Correlation of numerical values

``` {r plot2, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, results='hide', fig.keep='all', fig.width=8, fig.height=8, fig.align='center'}
...
ggplot(cor_df, aes(Var1, Var2)) +
  geom_point(aes(fill = Correlation), size = 12, shape = 21, color = "darkgrey") +
...
#### 2.3.4. Large vs. small tenants

```{r plot4, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, results='hide', fig.keep='all', fig.width=8, fig.height=3, fig.align='center'}
...
This chart contrasts two categories of landlords: `Small tenant` and `Large tenant`, based on the `Number of listings` they possess. The category `Small tenant` outnumbers `Large tenant owned`, indicating a slightly higher prevalence of landlords with fewer properties.

Given the context of rental tension zones, equality of small and  tenants may suggest a rental market with a concentrated number of players, potentially increasing the likelihood of monopolistic behavior affecting rental prices. However, the [recent legislation](https://www.boe.es/buscar/act.php?id=BOE-A-2023-12203) changed the definition of a large property owner from 10 to 5 properties. This meant that several former small tenants now qualify as large tenants, potentially altering the market dynamics and affecting the application of policies within stressed areas.

The number of listings from small tenants is over 9,000, a substantial figure that indicates the scale of their presence in the market. Large tenants listings, with a count above 8,000, although less than small tenants, represent a significant portion of the market as well. The data indicates that both small and large tenants play important roles in the housing ecosystem of Barcelona.
...
It's also worth noting that the presence of more small tenants could reflect a diverse range of property offerings, from single rooms to entire apartments, which may cater to different segments of the population. This might have a stabilizing effect on rental prices, as a diverse supply can meet varied demand. However, if small tenants begin to consolidate or if their listings push housing costs above the 30% income threshold, it could lead to increased regulatory scrutiny.

In conclusion, this chart suggests a competitive rental market in Barcelona, with a predominance of small tenants. With legislative changes, the landscape could shift, potentially impacting rent levels, housing availability, and the designation of rental tension zones. Stakeholders, including policymakers and market participants, would need to monitor these dynamics closely to understand the full implications of the law on the rental market.
...
#### 2.3.6. Average price by neighbourhood map overview

```{r plot6, echo=FALSE, error=FALSE, fig.align='center', fig.height=10, fig.keep='all', fig.width=10, message=FALSE, warning=FALSE, cache=TRUE, results='hide'}
...
ggmap(map_BCN) +
  geom_sf(data = merged_data,
          ...
          color = "#f1796f",
          linewidth = 0.4) +
  scale_fill_gradient(low = alpha("white", 0), high = "#f1796f") +
...
#### 2.3.7. Listings by minimum nights

```{r plot7, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, results='hide', fig.keep='all', fig.width=10, fig.height=5, fig.align='center'}
...
#### 2.3.9. Price by neighbourhood

```{r plot9, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, results='hide', fig.keep='all', fig.width=10, fig.height=8, fig.align='center'}
...
#### 2.3.10. Price by rating

```{r plot10, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, results='hide', fig.keep='all', fig.width=10, fig.height=5, fig.align='center'}
...
#### 2.3.11. Boxplots by price

```{r plot11, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, results='hide', fig.keep='all', fig.width=10, fig.height=5, fig.align='center'}
...
#### 2.3.12. Boxplots by minimum nights
...
#### 2.3.13. Boxplots by number of reviews
...
#### 2.3.14. Top hosts by number of listings

```{r plot14, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, results='hide', fig.keep='all', fig.width=8, fig.height=4, fig.align='center'}
...
#### 2.3.15. Proportion of Airbnb listings per person by neighbourhood group

```{r plot15, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, results='hide', fig.keep='all', fig.width=8, fig.height=4, fig.align='center'}
...
#### 2.3.16. Airbnb listings by neighbourhood group

```{r plot16, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, results='hide', fig.keep='all', fig.width=8, fig.height=4, fig.align='center'}
...
ggplot(listings_count, aes(x = reorder(neighbourhood_group,
  ...
  labs(x = "",
       ...
       title = "Number of Listings by Neighbourhood Group in Barcelona",
       subtitle = "Barcelona") +
...
#### 2.3.17. Airbnb listings map overview

```{r plot17, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, results='hide', fig.keep='all', fig.width=10, fig.height=10, fig.align='center'}
